...
import com.zzg.common.dto.QuartzConfigDTO;
import com.zzg.quartz.QuartzJobService;
...
public class QuartzContoller {
    private static final Logger log = LoggerFactory.getLogger(QuartzContoller.class);
